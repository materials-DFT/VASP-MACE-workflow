...
Skips VACF / power spectrum computation for faster runs. Uses the full
trajectory (no equilibration frame skipping). RDF and MSD data are still
written with --data-log if requested.
"""
